...
[![Release](https://img.shields.io/badge/release-v0.2.6-brightgreen)](https://github.com/gongzhujiejie/devswitch/releases)
...
完整版本历史见 [CHANGELOG.md](./CHANGELOG.md)。最新稳定版本为 **v0.2.6**。
